    ...
    <footer className="footer" id="footer">
          ...
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              ...
              <p className="footer__brand-desc">
                Repuestos de calidad para camionetas que exigen más. 
                Distribuidor especializado en Maxus, Toyota, Nissan, Mitsubishi y marcas líderes.
              </p>
            ...
            <div className="footer__col">
              ...
              <ul className="footer__col-contact">
                <li>
                  ...
                  <a href="https://wa.me/56968163883" target="_blank" rel="noopener noreferrer">
                    +56 9 6816 3883
                  </a>
                </li>
                <li>
                  ...
                  <span>Av. Ramón Picarte 2307, Valdivia</span>
                </li>
                <li>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/>
                  </svg>
                  <span>San Martín 492, Valdivia</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="footer__bottom">
        <div className="container">
          ...
          <p className="footer__bottom-tagline">Calidad que protege, rendimiento que impulsa.</p>
        </div>
      </div>
    </footer>
  );
